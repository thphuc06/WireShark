...
Trong khi đó, tại giây $6.803$s, packet 1927 có info `Application Data' với kích thước TLS Record là $3632$ bytes -- đây là \textbf{gói tin cuối cùng} chứa dữ liệu ảnh \texttt{pearson.png} được gửi về qua HTTPS. Hai quá trình tải diễn ra song song: ảnh \texttt{cover\_small.jpg} đã hoàn thành ($6.49$s) trong khi \texttt{pearson.png} nhận đủ dữ liệu lúc $6.803$s ở packet 1927.
\newpage
